export const products = [
  ...
  },
  {
    ...
    badge: "신상품",
    name: "Santal Mist",
    shortDesc: "크리미 우드, 앰버, 모스",
    price: "₩68,000",
    image: "/product2.png",
    longDesc:
      "크리미한 우드 베이스에 앰버와 모스가 어우러진 깊고 따뜻한 향. 냉압착 식물성 미스트 포뮬러로 피부에 순하게 밀착되며 체온에 반응해 자연스럽게 향을 발산합니다.",
    specs: [
      { label: "용량", value: "50ml" },
      { label: "주요 성분", value: "샌달우드, 앰버, 오크모스" },
      { label: "지속력", value: "8~12시간" },
      { label: "타입", value: "보태니컬 미스트" },
      { label: "알코올", value: "프리" },
      { label: "파라벤", value: "프리" },
    ],
    features: [
      { title: "식물성 원료", desc: "냉압착 추출 샌달우드 오일을 사용합니다." },
      { title: "피부 밀착", desc: "체온에 반응해 향이 자연스럽게 발산됩니다." },
      { title: "저자극 포뮬러", desc: "알코올 프리, 파라벤 프리 포뮬러입니다." },
    ],
  },
  {
    slug: "oud-herb",
