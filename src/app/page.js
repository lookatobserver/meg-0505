  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: "#f8f8f6", minHeight: "100vh", fontFamily: "var(--font-sans)" }}>
        ...
        {/* ── Header ── */}
        <NavHeader navItems={gnbItems} rightContent={rightContent} />

        {/* onClickCapture wraps content only (not the header) */}
        <div
          onClickCapture={(e) => {
        ...
        >
          ...
          {/* ── Hero ── */}
          <section className="rsp-pad" style={{ textAlign: "center", padding: "80px 40px 60px" }}>
            <p style={{
              fontSize: 11,
          ...
          {/* ── Products ── */}
          <section className="rsp-pad" style={{ padding: "80px 56px 100px", maxWidth: 1280, margin: "0 auto" }}>
          ...
          {/* ── What we capture ── */}
          <section className="rsp-pad" style={{ backgroundColor: "#111", padding: "100px 56px" }}>
            <div
              className="rsp-2col"
              style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, maxWidth: 1080, margin: "0 auto", alignItems: "center" }}
            >
              {/* Circular image */}
              <div style={{ display: "flex", justifyContent: "center" }}>
                <div
                  className="rsp-circle"
                  style={{
                    width: 480,
                    height: 480,
                    borderRadius: "50%",
          ...
          {/* ── Origin ── */}
          <section className="rsp-pad" style={{ padding: "100px 40px", textAlign: "center", backgroundColor: "#f8f8f6" }}>
          ...
          <footer style={{ backgroundColor: "#ffffff", borderTop: "1px solid #ebebeb" }}>
            <div className="rsp-pad" style={{ maxWidth: 1200, margin: "0 auto", padding: "60px 56px 36px" }}>
              <div
                className="rsp-footer-grid"
                style={{ display: "grid", gridTemplateColumns: "1.5fr 1fr 1fr 1.5fr", gap: 48, marginBottom: 48 }}
              >
                <div>
                  <div style={{
                    fontFamily: "var(--font-cormorant), Georgia, serif",
              ...
              <div
                className="rsp-footer-bottom"
                style={{ borderTop: "1px solid #ebebeb", paddingTop: 22, display: "flex", justifyContent: "space-between", alignItems: "center" }}
              >
