...
const ceoMessage = [
  {
    type: "body",
    text: "MEG(Microbial Eco Guardians)를 찾아주신 여러분께 진심으로 감사드립니다.\n저는 한서대학교산학연구원에서 미생물 발효 기술을 연구해 오며,\n오랫동안 한 가지 질문을 붙들고 있었습니다.",
  },
  {
    type: "quote",
  ...
  {
    type: "body",
    text: "강한 화학 성분으로 냄새를 덮는 방식은 근본적인 해결이 아닙니다.\n악취를 일으키는 균과 유기 분자 자체를 제거하지 않는 한,\n문제는 반드시 되돌아옵니다.",
  },
  {
    type: "heading",
    text: "자연에서 찾은 답",
  ...
  {
    type: "body",
    text: "수질 정화에서 토양 복원까지, 자연은 이미 완벽한 정화 시스템을 갖추고 있습니다.\n그 핵심이 바로 유용미생물(EM)입니다.",
  },
  {
    type: "body",
    text: "유산균·락토바실러스·비피더스균·바실러스균, 이 네 가지 살아있는 균이\n악취의 원인 분자를 직접 분해하고 유해균의 증식을 억제합니다.\n독소 없이, 인공 성분 없이, 오직 자연의 힘만으로.",
  },
  {
    type: "body",
  ...
  {
    type: "closing",
    text: "자기 환경을 생각하는 기술, 자연에서 답을 찾는 연구.\nMEG는 그 신념 위에 서 있습니다.",
  },
  {
    type: "closing",
    text: "당신의 공간이 다시 숨 쉬기를 바랍니다.",
  },
  {
    type: "sign",
    text: "감사합니다.",
    ...
    <div style={{ backgroundColor: "#f8f8f6", minHeight: "100vh" }}>
      ...
      <section style={{
        ...
        <p style={{
          ...
          &ldquo;당신의 공간을 다시 숨 쉬게, MEG가 만드는 일상.&rdquo;
        </p>
